...
export interface components {
    schemas: {
        ...
        "Create-noteRequest": {
             ...
             * @example https://example.com/schemas/Create-noteRequest.json
             */
        ...
        Note: {
             ...
             * Format: uri
             * @description A URL to the JSON Schema for this object.
             * @example https://example.com/schemas/Note.json
             */
            readonly $schema?: string;
            body: string;
            /** Format: date-time */
...
export interface operations {
    ...
    "list-notes": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Note"][] | null;
                };
            };
            /** @description Error */
            default: {
    ...
    "create-note": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Create-noteRequest"];
            };
        };
        responses: {
            /** @description Created */
